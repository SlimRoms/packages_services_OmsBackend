            ...
            try {
                ...
                if (aInfo.metaData != null && aInfo.metaData.containsKey("Substratum_Name")) {
                    ...
                    if (!supportsThirdParty) {
                        ...
                        Intent activity = new Intent(context, UnsupportedThemeDialogActivity.class);
                        activity.putExtra("Substratum_Name", aInfo.metaData.getString("Substratum_Name"));
                        activity.putExtra("package_name", packageName);
